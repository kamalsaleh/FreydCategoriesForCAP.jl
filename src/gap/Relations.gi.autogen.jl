  ...
  function( category )
    ...
    AddIsWellDefinedForMorphisms( category,
      function( cat, alpha )
        ...
        if (@not IsWellDefinedForMorphisms( arrow ))
          
          return false;
          
        end;
        
        if (@not IsWellDefinedForMorphisms( reversed ))
          
          return false;
          
        end;
        
        if (@not IsEqualForObjects( Source( arrow ), Source( reversed ) ))
          
          return false;
          
        end;
        
        if (@not IsEqualForObjects( UnderlyingOriginalObject( Range( alpha ) ), Range( arrow ) ))
          
          return false;
          
        end;
        
        if (@not IsEqualForObjects( UnderlyingOriginalObject( Source( alpha ) ), Range( reversed ) ))

...
# Implementations
#
@BindGlobal( "ADD_FUNCTIONS_FOR_CategoryOfRows_as_AdditiveClosure_RingAsCategory_ArbitraryRing_precompiled", function ( cat )
...
@BindGlobal( "CategoryOfRows_as_AdditiveClosure_RingAsCategory_ArbitraryRing_precompiled", function ( homalg_ring )

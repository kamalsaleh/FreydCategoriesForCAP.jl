...
function ( cat_1, alpha_1 )
    ...
    deduped_1_1 = UnderlyingCategory( cat_1 );
    if (@not IsWellDefinedForMorphisms( deduped_1_1, deduped_2_1 ))
        return false;
    elseif (@not IsColiftable( deduped_1_1, CoRelationMorphism( Source( alpha_1 ) ), PreCompose( deduped_1_1, deduped_2_1, CoRelationMorphism( Range( alpha_1 ) ) ) ))
        return false;
    else
        return true;
    end;
...
function ( cat_1, arg2_1 )
    if (@not IsWellDefinedForMorphisms( UnderlyingCategory( cat_1 ), CoRelationMorphism( arg2_1 ) ))
        return false;
    else
        return true;
    end;

...
# Implementations
#
@BindGlobal( "ADD_FUNCTIONS_FOR_CategoryOfColumns_as_Opposite_CategoryOfRows_Field_precompiled", function ( cat )
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    deduped_3_1 = RankOfObject( r_1 );
    hoisted_2_1 = RankOfObject( a_1 );
    deduped_1_1 = RankOfObject( b_1 );
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, UnderlyingMatrix, CertainRows( HomalgIdentityMatrix( deduped_3_1, UnderlyingRing( cat_1 ) ), List( (1):(deduped_3_1), function ( i_2 )
                local deduped_1_2;
                deduped_1_2 = i_2 - 1;
...
function ( cat_1, alpha_1, C_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( alpha_1 ), C_1, UnderlyingMatrix, BasisOfRows( UnderlyingMatrix( alpha_1 ) ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, Range( alpha_1 ), CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberRows( deduped_1_1 ) ), UnderlyingMatrix, deduped_1_1 );
end
########
...
########
function ( cat_1, alpha_1, beta_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, Range( alpha_1 ), Range( beta_1 ), UnderlyingMatrix, SafeRightDivide( UnderlyingMatrix( beta_1 ), UnderlyingMatrix( alpha_1 ) ) );
end
########
...
function ( cat_1, epsilon_1, tau_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, Range( epsilon_1 ), Range( tau_1 ), UnderlyingMatrix, UniqueRightDivide( UnderlyingMatrix( tau_1 ), UnderlyingMatrix( epsilon_1 ) ) );
end
########
...
function ( cat_1, alpha_1, S_1, i_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, S_1[i_1], Range( alpha_1 ), UnderlyingMatrix, CertainColumns( UnderlyingMatrix( alpha_1 ), (deduped_1_1 + 1):(deduped_1_1 + deduped_2_1[i_1]) ) );
end
########
...
function ( cat_1, alpha_1, S_1, i_1 )
    ...
    deduped_2_1 = List( S_1, RankOfObject );
    deduped_1_1 = Sum( deduped_2_1[(1):(i_1 - 1)] );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( alpha_1 ), S_1[i_1], UnderlyingMatrix, CertainRows( UnderlyingMatrix( alpha_1 ), (deduped_1_1 + 1):(deduped_1_1 + deduped_2_1[i_1]) ) );
end
########
...
function ( cat_1, alpha_1, I_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, I_1, Range( alpha_1 ), UnderlyingMatrix, BasisOfColumns( UnderlyingMatrix( alpha_1 ) ) );
end
########
...
function ( cat_1, a_1, b_1 )
    local deduped_1_1;
    deduped_1_1 = ReducedSyzygiesOfRows( UnderlyingMatrix( a_1 ), UnderlyingMatrix( b_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, Range( a_1 ), CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberRows( deduped_1_1 ) ), UnderlyingMatrix, deduped_1_1 );
end
########
...
function ( cat_1, source_1, range_1, alpha_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, UnderlyingMatrix, ConvertRowToMatrix( UnderlyingMatrix( alpha_1 ), RankOfObject( range_1 ), RankOfObject( source_1 ) ) );
end
########
...
function ( cat_1, alpha_1 )
    ...
    if (@not IsHomalgMatrix( deduped_1_1 ))
        return false;
    elseif (@not NumberRows( deduped_1_1 ) == RankOfObject( Range( alpha_1 ) ))
        return false;
    elseif (@not NumberColumns( deduped_1_1 ) == RankOfObject( Source( alpha_1 ) ))
        return false;
    else
        return true;
    end;
...
function ( cat_1, arg2_1 )
    ...
    if (@not IsInt( deduped_1_1 ))
        return false;
    elseif (@not deduped_1_1 >= 0)
        return false;
    else
        return true;
    end;
...
function ( cat_1, alpha_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberColumns( deduped_1_1 ) ), Source( alpha_1 ), UnderlyingMatrix, deduped_1_1 );
end
########
...
########
function ( cat_1, alpha_1, beta_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( alpha_1 ), Source( beta_1 ), UnderlyingMatrix, SafeLeftDivide( UnderlyingMatrix( beta_1 ), UnderlyingMatrix( alpha_1 ) ) );
end
########
...
function ( cat_1, iota_1, tau_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, Source( tau_1 ), Source( iota_1 ), UnderlyingMatrix, UniqueLeftDivide( UnderlyingMatrix( iota_1 ), UnderlyingMatrix( tau_1 ) ) );
end
########
...
function ( cat_1, objects_1, k_1, P_1 )
    ...
    deduped_2_1 = UnderlyingRing( cat_1 );
    deduped_1_1 = deduped_3_1[k_1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, P_1, objects_1[k_1], UnderlyingMatrix, UnionOfColumns( deduped_2_1, deduped_1_1, [ HomalgZeroMatrix( deduped_1_1, Sum( deduped_3_1[(1):(k_1 - 1)] ), deduped_2_1 ), HomalgIdentityMatrix( deduped_1_1, deduped_2_1 ), HomalgZeroMatrix( deduped_1_1, Sum( deduped_3_1[(k_1 + 1):(Length( objects_1 ))] ), deduped_2_1 ) ] ) );
end
########
...
function ( cat_1, a_1, b_1 )
    local deduped_1_1;
    deduped_1_1 = ReducedSyzygiesOfColumns( UnderlyingMatrix( a_1 ), UnderlyingMatrix( b_1 ) );
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberColumns( deduped_1_1 ) ), Source( a_1 ), UnderlyingMatrix, deduped_1_1 );
end
########
...
function ( cat_1, alpha_1 )
    local deduped_1_1;
    deduped_1_1 = CATEGORY_OF_COLUMNS_ReductionBySplitEpiSummandTuple( alpha_1 )[1];
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberColumns( deduped_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberRows( deduped_1_1 ) ), UnderlyingMatrix, deduped_1_1 );
end
########
...
function ( cat_1, alpha_1 )
    local deduped_1_1;
    deduped_1_1 = CATEGORY_OF_COLUMNS_ReductionBySplitEpiSummandTuple( alpha_1 )[2];
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberColumns( deduped_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberRows( deduped_1_1 ) ), UnderlyingMatrix, deduped_1_1 );
end
########
...
function ( cat_1, alpha_1 )
    local deduped_1_1;
    deduped_1_1 = CATEGORY_OF_COLUMNS_ReductionBySplitEpiSummandTuple( alpha_1 )[3];
    return CreateCapCategoryMorphismWithAttributes( cat_1, CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberColumns( deduped_1_1 ) ), CreateCapCategoryObjectWithAttributes( cat_1, RankOfObject, NumberRows( deduped_1_1 ) ), UnderlyingMatrix, deduped_1_1 );
end
########
...
function ( cat_1, source_1, list_of_morphisms_1, range_1 )
    return CreateCapCategoryMorphismWithAttributes( cat_1, source_1, range_1, UnderlyingMatrix, Sum( List( list_of_morphisms_1, UnderlyingMatrix ), HomalgZeroMatrix( RankOfObject( range_1 ), RankOfObject( source_1 ), UnderlyingRing( cat_1 ) ) ) );
end
########
...
@BindGlobal( "CategoryOfColumns_as_Opposite_CategoryOfRows_Field_precompiled", function ( homalg_ring )

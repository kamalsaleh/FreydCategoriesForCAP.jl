...
# Implementations
#
@BindGlobal( "ADD_FUNCTIONS_FOR_CategoryOfRows_as_AdditiveClosure_RingAsCategory_Field_precompiled", function ( cat )
...
function ( cat_1, s_1, a_1, b_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, UnderlyingMatrix, CertainRows( HomalgIdentityMatrix( deduped_5_1, UnderlyingRing( cat_1 ) ), List( (1):(deduped_5_1), function ( i_2 )
                local deduped_1_2;
                deduped_1_2 = i_2 - 1;
...
function ( cat_1, alpha_1 )
    ...
    if (@not IsHomalgMatrix( deduped_1_1 ))
        return false;
    elseif (@not NumberRows( deduped_1_1 ) == RankOfObject( Source( alpha_1 ) ))
        return false;
    elseif (@not NumberColumns( deduped_1_1 ) == RankOfObject( Range( alpha_1 ) ))
        return false;
    else
        return true;
    end;
...
@BindGlobal( "CategoryOfRows_as_AdditiveClosure_RingAsCategory_Field_precompiled", function ( homalg_ring )

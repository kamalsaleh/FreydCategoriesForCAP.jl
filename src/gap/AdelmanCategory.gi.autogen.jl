...
@InstallMethod( AdelmanCategory,
  ...
  function( CAP_NAMED_ARGUMENTS, underlying_category )
    ...
    for func in [ "Lift", "IsLiftable", "Colift", "IsColiftable", "SubtractionForMorphisms", "AdditionForMorphisms", "PreCompose", "IdentityMorphism" ]
        
        if (@not CanCompute( underlying_category, func ))
    ...
    if (@not CanCompute( underlying_category, "SolveLinearSystemInAbCategory" ))
...
@InstallMethod( AdelmanCategoryObject,
  ...
  function( category, relation_morphism, corelation_morphism )
    ...
    if (@not IsEqualForObjects( Range( relation_morphism ), Source( corelation_morphism ) ))
...
@InstallMethod( AdelmanCategoryMorphism,
  ...
  function( category, source, morphism_datum, range )
    ...
    if (@not IsEqualForObjects( Source( morphism_datum ), Source( CorelationMorphism( source ) ) ))
    ...
    if (@not IsEqualForObjects( Range( morphism_datum ), Source( CorelationMorphism( range ) ) ))
  ...
  function( category )
    ...
    AddIsWellDefinedForObjects( category,
      function( cat, object )
        ...
        if (@not IsWellDefined( relation_morphism ) 
           || @not IsWellDefined( corelation_morphism ))
            
            return false;
            
        end;
        
        if (@not IsEqualForObjects( Source( corelation_morphism ), Range( relation_morphism ) ))
    ...
    AddIsWellDefinedForMorphisms( category,
      function( cat, morphism )
        ...
        if (@not IsLiftable( PreCompose( RelationMorphism( Source( morphism ) ), UnderlyingMorphism( morphism ) ), RelationMorphism( Range( morphism ) ) ))
            
            return false;
            
        end;
        
        if (@not IsColiftable( CorelationMorphism( Source( morphism ) ), PreCompose( UnderlyingMorphism( morphism ), CorelationMorphism( Range( morphism ) ) ) ))
    ...
    if (ForAll( [ "DistinguishedObjectOfHomomorphismStructure" ],
        ...
        elseif ( HasIsAdditiveCategory( range_category ) &&
              IsAdditiveCategory( range_category ) &&
              ForAll(
                   [ "Lift",
        ...
        if (homomorphism_structure_derivation_case != "none")
...
@InstallMethod( AdelmanCategoryFunctorInducedByUniversalProperty,
  ...
  function( functor ) 
    ...
    if (@not ForAll( [ "HomologyObject", "HomologyObjectFunctorialWithGivenHomologyObjects" ], f -> CanCompute( range, f ) ))
  ...
  function( underlying_category )
    ...
    AddObjectFunction( right_sat,
      function( adel_obj )
        ...
        if (@not IsSequenceAsAdelmanCategoryObject( adel_obj ))
...
@InstallMethod( IsExact,
  ...
  function( object )
    ...
    return IsLeftExact( object ) && IsRightExact( object );
...
@InstallMethod( IsImagePreserving,
  ...
  function( object )
    ...
    return IsMonoPreserving( object ) && IsEpiPreserving( object );
...
@InstallMethod( /,
  ...
  function( object, adel )
    ...
    if (@not IsIdenticalObj( CapCategory( object ), UnderlyingCategory( adel ) ))
...
@InstallMethod( /,
  ...
  function( freyd_obj, adel )
    ...
    if (@not IsIdenticalObj( underlying_category, UnderlyingCategory( adel ) ))
...
@InstallMethod( /,
  ...
  function( morphism, adel )
    ...
    if (@not IsIdenticalObj( CapCategory( morphism ), UnderlyingCategory( adel ) ))
